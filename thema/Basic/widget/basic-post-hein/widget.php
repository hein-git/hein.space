...
$wset['thumb_w'] = (isset($wset['thumb_w']) && $wset['thumb_w'] > 0) ? $wset['thumb_w'] : 500;
...
$img_height = $wset['thumb_h'];
//$img_width = $wset['thumb_w'];
$img_width = round($img_height / ($img_h / 100));
// 간격
...
<style>
	...
	#<?php echo $widget_id;?> .post-subject { height:<?php echo $line_height;?>px; margin-top:5px }
...
<div id="<?php echo $widget_id;?>" class="basic-post-hein">
	<?php 
